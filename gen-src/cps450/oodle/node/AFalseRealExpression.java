...
public final class AFalseRealExpression extends PRealExpression
{
    private TFalse _false_;

    public AFalseRealExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFalseRealExpression(
            cloneNode(this._false_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAFalseRealExpression(this);
    }
