...
public final class AStringRealExpression extends PRealExpression
{
    private TStrlit _strlit_;

    public AStringRealExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStringRealExpression(
            cloneNode(this._strlit_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAStringRealExpression(this);
    }
