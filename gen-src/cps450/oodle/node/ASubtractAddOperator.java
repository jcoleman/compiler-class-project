...
public final class ASubtractAddOperator extends PAddOperator
{
    private TMinusOp _minusOp_;

    public ASubtractAddOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASubtractAddOperator(
            cloneNode(this._minusOp_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseASubtractAddOperator(this);
    }
